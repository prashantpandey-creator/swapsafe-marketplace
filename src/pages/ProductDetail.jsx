    ...
    if (isLoading) {
        return (
            <div className="min-h-screen pt-24 pb-12 flex justify-center">
                <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[var(--m-accent)]"></div>
            </div>
        )
    }
    ...
    if (!product) {
        return (
            <div className="min-h-screen pt-24 pb-12 container mx-auto px-4 text-center">
                ...
                <p className="text-[var(--m-fg-muted)] mb-6">The listing you are looking for has been removed or sold.</p>
    ...
    return (
        <div className="pt-24 pb-12 min-h-screen bg-legion-bg">
            <div className="container mx-auto px-4">
                {/* Breadcrumb */}
                <nav className="flex items-center gap-2 text-sm text-[var(--m-fg-muted)] mb-6">
                    <Link to="/" className="hover:text-[var(--m-accent)] transition-colors">Home</Link>
                    <span>/</span>
                    <Link to="/browse" className="hover:text-[var(--m-accent)] transition-colors">Marketplace</Link>
                    <span>/</span>
                    <span className="text-[var(--m-fg-subtle)] truncate max-w-[200px]">{title}</span>
                </nav>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                    ...
                    <div className="lg:col-span-7 space-y-4">
                        {/* Main Image Stage */}
                        <div className="relative aspect-[4/3] bg-legion-card rounded-[12px] overflow-hidden border border-[var(--m-hairline)] group">
                            <img
                            ...
                            <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
                                {images.map((img, idx) => (
                                    <button
                                        ...
                                        className={`relative w-24 h-24 flex-shrink-0 rounded-[10px] overflow-hidden border-2 transition-all ${selectedImage === idx ? 'border-[var(--m-accent)]' : 'border-transparent opacity-60 hover:opacity-100'
                                            }`}
                                    >
                    ...
                    <div className="lg:col-span-5 space-y-6">
                            ...
                            {!isOwnListing ? (
                                <div className="space-y-3">
                                    ...
                                    <button
                                        ...
                                        className="w-full text-[var(--m-fg-subtle)] hover:text-red-400 text-sm py-2 transition-colors flex items-center justify-center gap-2"
                                    >
                                        <Flag size={14} />
                                        Report this listing
                                    </button>
                        ...
                        <div className="glass-panel border border-[var(--m-hairline)] rounded-[12px] p-6">
                            ...
                            <Link to={`/profile/${safeSeller._id || safeSeller.id}`} className="flex items-center gap-4 group">
                                <div className="relative">
                                    <img
                                        ...
                                        alt={safeSeller.name}
                                        className="w-14 h-14 rounded-full object-cover ring-2 ring-[var(--m-hairline)] group-hover:ring-[var(--m-accent)] transition-all"
                                    />
                            ...
                            {/* Delivery Options */}
                            <div className="bg-legion-card border border-[var(--m-hairline)] rounded-[12px] p-6 mt-6">
                                <h3 className="text-sm font-bold text-[var(--m-fg-subtle)] uppercase tracking-widest mb-4">Delivery Options</h3>
                                <div className="space-y-3">
                                    ...
                                    <Link
                                        ...
                                        className="flex items-center gap-3 p-3 rounded-[10px] border bg-[var(--m-surface)] border-[var(--m-hairline)] hover:bg-[var(--m-surface-strong)] transition-colors cursor-pointer"
                                    >
                            ...
                            {aiVerified && (
                                <div className="bg-legion-card border border-green-500/20 rounded-[12px] p-6 mt-6">
                    ...
                    >
                        ...
                        <div className="flex gap-3 mt-4 justify-end">
                            ...
                            <button
                                ...
                                className="bg-[var(--m-accent)] text-black font-bold px-6 py-2 rounded-[10px] hover:opacity-90 transition-opacity"
                            >
                                Send Message
                            </button>
                        </div>
